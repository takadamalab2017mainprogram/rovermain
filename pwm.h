...
*/
class PWM : public TaskBase
{
private:
	static struct channel channels[DMA_CHANNELS];
	static uint16_t pulse_width_incr_us;
	static uint8_t _is_setup;
	static int gpio_setup; // bitfield for setup gpios (setup = out/low)
