...
const static double MOTOR_MAX_POWER_CHANGE = MOTOR_MAX_POWER / 10;//モータ出力の1秒あたりの最大変化量
...
const static double ROVER_WAKING_DRIVE_TIME = 1;//ローバーの姿勢を戻したいときに前進する時間
...
const static double SEPARATING_PARA_DETECT_THRESHOLD = 0.1;//この割合以上パラシュート色が検出されたらパラが存在するものとする
